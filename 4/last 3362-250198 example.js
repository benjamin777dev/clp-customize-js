...
const generateTimerElement = ()=>{
    const gridElement = document.querySelector('#countTimerBody');
    if(gridElement){
...
const updateCheckoutBtn = ()=>{
    ...
    const checkoutBtn = [...document.querySelectorAll("button")]
  .find(btn => btn.textContent.trim() === "Next" && btn.classList.contains("relative"));
    ...
    <div class="testimonial-container">
        <div class="testimonial-slider" id="testimonialSlider">
            <div class="testimonial active">
                ...
                <div class="author">
                    <div class="author-info">
                        <img src="https://i.postimg.cc/SspS8rvY/Ariane-Barcellos-lost-79-lbs.png" alt="author avatar">
            ...
            <div class="testimonial">
                ...
                <div class="author">
                    <div class="author-info">
                        <img src="https://i.postimg.cc/cJ31rjXN/Claudia-Coy-lost-52-lbs.png" alt="author avatar">
            ...
            <div class="testimonial">
                ...
                <div class="author">
                    <div class="author-info">
                        <img src="https://i.postimg.cc/cL241Z7m/Kat-Ristow-lost-28-lbs-28-lbs-2.png" alt="author avatar">
    ...
    <div class="help-section">
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
            ...
            <div class="availability">
                ...
                Available <span style="font-weight: bold">10 AM - 6 PM ET, Mon-Fri</span>
            </div>
        </div>
...

{
    ...
    const checkForm = setInterval(() => {
        ...
        if (targetElement) {
            ...
            clearInterval(checkForm);
            console.warn("targetElement not found after 5 seconds.");
        }
